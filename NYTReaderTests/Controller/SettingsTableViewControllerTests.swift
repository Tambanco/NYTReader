...
class SettingsTableViewControllerTests: XCTestCase {
    ...
    func testTableViewNotNilWhenViewIsLoaded() {
        ...
        let vc = storyboard.instantiateViewController(withIdentifier: String(describing: SettingsTableViewController.self))
        let sut = vc as! SettingsTableViewController
